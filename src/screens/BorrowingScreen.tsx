...
export function BorrowingScreen() {
 ...
 const publicKey = "HLFM7GmwN4NXvK2SuhmLFiADHq8UdK6i4uNxgkRD5aT5";
        ...
        <View>
          ...
          <View style={tw`w-full flex-row pt-2 pb-1 px-2 text-center`}>
            <View style={tw`w-1/2 py-1 pb-1`}>
              ...
              <Text
                style={[
                  tw`text-sm font-semibold text-red-400`,
                  globalStyles.customFont,
                ]}
              >
                - {interestDueSol}
  ...
  const totalLoanValue = openBorrowingData.reduce((total, item) => {
    const principalAmountSol = item.accountAddress
      ? item.amount / 10 ** 9
      : item.principalAmount / 10 ** 9;
        ...
        {loading ? (
          ...
          <>
            <View style={tw`mb-6 mx-2`}>
              <Text
                style={[
                  tw`text-lg mt-2 mb-4 ml-2 font-semibold text-gray-100`,
                  globalStyles.customFont,
                ]}
              >
              ...
              >
                ...
                <View style={tw`w-2/5 items-center`}>
                  ...
                  <View style={tw`flex-row`}>
                    <Text
                      style={[
                        tw`text-[26px] font-semibold text-red-400 mt-1`,
                        globalStyles.customFont,
                      ]}
                    >
